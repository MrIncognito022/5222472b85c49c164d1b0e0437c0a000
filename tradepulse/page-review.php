	...
	<section id="latest-reviews" class="section firm-feed">
		<div class="wrap">
			<div class="section-heading">
				<div>
					<span class="eyebrow"><?php esc_html_e( 'Review library', 'tradepulse' ); ?></span>
					<h2><?php esc_html_e( 'Latest Firm Reviews', 'tradepulse' ); ?></h2>
				</div>
				<p><?php esc_html_e( 'New and updated reviews are shown first, so readers see the most relevant firm information.', 'tradepulse' ); ?></p>
			</div>
				...
				<?php foreach ( $firm_reviews as $index => $firm ) : ?>
					<article class="prop-review-card prop-review-card--<?php echo esc_attr( $index + 1 ); ?>">
						<header class="prop-review-card__identity">
							<span class="prop-review-card__logo"><?php echo esc_html( $firm['initials'] ); ?></span>
							<div class="prop-review-card__name"><span><?php echo esc_html( $firm['best_for'] ); ?></span><h3><?php echo esc_html( $firm['name'] ); ?></h3></div>
							<div class="prop-review-card__score"><strong><?php echo esc_html( $firm['score'] ); ?></strong><span>/ 5 &middot; <?php echo esc_html( $firm['verdict'] ); ?></span></div>
						</header>
